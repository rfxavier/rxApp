<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="cnUsuariosCofreDetalhe.aspx.cs" Inherits="rxApp.frmAgyliti.GetLock.cnUsuariosAdmin.cnUsuariosCofreDetalhe" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContentPlaceHolderMain" runat="server">
    ...
    <dx:ASPxHyperLink ID="ASPxHyperLink1" runat="server" Text="<< Voltar" CssClass="button" NavigateUrl="~/frmAgyliti/GetLock/cnUsuariosAdmin/cnUsuariosCofre.aspx">
    </dx:ASPxHyperLink>
