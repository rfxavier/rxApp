...
{
    public partial class cnCofreUsuarioDepositosPorCliente : System.Web.UI.Page
    {
        private ApplicationUserManager userManager;

        public cnCofreUsuarioDepositosPorCliente()
        {
        ...
        protected void ASPxDashboard1_DataLoading(object sender, DataLoadingWebEventArgs e)
        {
            ...
            if (user.GetLockClienteId != null) e.Data = dsCofre.GetDepositosMessageViewsPorCliente((long)user.GetLockClienteId);
        }
