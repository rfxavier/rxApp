...
namespace rxApp.frmAgyliti.GetLock.cnRelatorios
{
    public partial class cnGridGetInfo : System.Web.UI.Page
    {
        ...
        protected void ASPxGridView1_DataBinding(object sender, EventArgs e)
        {
            ...
            LinqServerModeDataSource lnsource = new LinqServerModeDataSource { ContextTypeName = "rxApp.Models.ApplicationDbContext", TableName = "GetLockMessageAckGetInfos" };
        ...
        protected void EntityServerModeDataSource1_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            e.QueryableSource = db.GetLockMessageAckGetInfos;
        }
