<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="cnGridDepositosAuditoria.aspx.cs" Inherits="rxApp.frmAgyliti.GetLock.cnRelatorios.cnGridDepositosAuditoria" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContentPlaceHolderMain" runat="server">
    <strong>Auditoria Depósitos</strong>
    <dx:ASPxGridView runat="server" Width="100%" AutoGenerateColumns="False" KeyFieldName="id" ID="ASPxGridView1" OnDataBinding="ASPxGridView1_DataBinding" OnCustomUnboundColumnData="ASPxGridView1_CustomUnboundColumnData">
        ...
        <Columns>
            <dx:GridViewDataDateColumn FieldName="data_tmst_end_datetime" SortIndex="0" SortOrder="Descending" ShowInCustomizationForm="True" Caption="Data Depósito" VisibleIndex="0">
                <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy" EditFormatString="dd/MM/yyyy"></PropertiesDateEdit>

                <CellStyle Wrap="False"></CellStyle>
            </dx:GridViewDataDateColumn>
            <dx:GridViewDataDateColumn FieldName="data_tmst_end_datetime" SortIndex="1" SortOrder="Descending" ShowInCustomizationForm="True" Settings-AllowAutoFilter="False" Settings-AllowHeaderFilter="False" Settings-ShowInFilterControl="False" Caption="Hora Depósito" VisibleIndex="1">
                <PropertiesDateEdit DisplayFormatString="HH:mm:ss" EditFormatString="HH:mm:ss"></PropertiesDateEdit>

                <CellStyle Wrap="False"></CellStyle>
            </dx:GridViewDataDateColumn>

            <dx:GridViewDataDateColumn FieldName="trackCreationTime" SortIndex="0" SortOrder="Descending" ShowInCustomizationForm="True" Caption="Data Servidor" VisibleIndex="2">
                <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy" EditFormatString="dd/MM/yyyy"></PropertiesDateEdit>

                <CellStyle Wrap="False"></CellStyle>
            </dx:GridViewDataDateColumn>
            <dx:GridViewDataDateColumn FieldName="trackCreationTime" SortIndex="1" SortOrder="Descending" ShowInCustomizationForm="True" Settings-AllowAutoFilter="False" Settings-AllowHeaderFilter="False" Settings-ShowInFilterControl="False" Caption="Hora Servidor" VisibleIndex="3">
                <PropertiesDateEdit DisplayFormatString="HH:mm:ss" EditFormatString="HH:mm:ss"></PropertiesDateEdit>

                <CellStyle Wrap="False"></CellStyle>
            </dx:GridViewDataDateColumn>

            <dx:GridViewDataTextColumn FieldName="DateTimeDiff" UnboundType="String" Settings-AllowAutoFilter="False" Settings-AllowHeaderFilter="False" Settings-ShowInFilterControl="False" Caption="Diferença de Tempo" VisibleIndex="4">
            ...
            <dx:GridViewDataTextColumn FieldName="id_cofre" ShowInCustomizationForm="True" Caption="ID Cofre" VisibleIndex="6"></dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="movimento_nome" ShowInCustomizationForm="True" Caption="Movimento" VisibleIndex="7"></dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="cofre_nome" ShowInCustomizationForm="True" Caption="Nome Cofre" VisibleIndex="8"></dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="cod_loja" ShowInCustomizationForm="True" Caption="C&#243;d.Loja" VisibleIndex="9"></dx:GridViewDataTextColumn>
            ...
            <dx:GridViewDataTextColumn FieldName="TotalValueAuto" UnboundType="Decimal" Caption="Total Valor Automático" VisibleIndex="61">
                <PropertiesTextEdit DisplayFormatString="#,#0" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="TotalValueManual" UnboundType="Decimal" Caption="Total Valor Manual" VisibleIndex="62">
                <PropertiesTextEdit DisplayFormatString="#,#0" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="TotalValue" UnboundType="Decimal" Caption="Total Valor" VisibleIndex="63">
                <PropertiesTextEdit DisplayFormatString="#,#0" />
            </dx:GridViewDataTextColumn>
        ...
        <SettingsExport EnableClientSideExportAPI="true" ExcelExportMode="WYSIWYG" FileName="GetLock-Depositos-Auditoria" />
    </dx:ASPxGridView>
</asp:Content>
