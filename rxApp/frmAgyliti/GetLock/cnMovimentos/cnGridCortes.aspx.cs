        ...
        protected void ASPxGridView1_DataBinding(object sender, EventArgs e)
        {
            ...
            else if (User.IsInRole("UserClient"))
            {
                ...
                if (Session["selectedLojas"] != null && (Session["dateStart"] != null) && (Session["dateEnd"] != null))
                {
                    ...
                    ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "6") && m.cod_cliente == codCliente && selectedLojas.Contains(m.id_loja) && m.data_tmst_end_datetime >= dateStart && m.data_tmst_end_datetime <= dateEnd).ToList();
                }
                else if (Session["selectedLojas"] != null && (Session["dateStart"] != null) && (Session["dateEnd"] == null))
                {
                    var selectedLojas = (List<long>)Session["selectedLojas"];

                    ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "6") && m.cod_cliente == codCliente && selectedLojas.Contains(m.id_loja) && m.data_tmst_end_datetime >= dateStart).ToList();
                }
                else if (Session["selectedLojas"] != null && (Session["dateStart"] == null) && (Session["dateEnd"] != null))
                {
                    var selectedLojas = (List<long>)Session["selectedLojas"];

                    ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "6") && m.cod_cliente == codCliente && selectedLojas.Contains(m.id_loja) && m.data_tmst_end_datetime <= dateEnd).ToList();
                }
                else if (Session["selectedLojas"] == null && (Session["dateStart"] != null) && (Session["dateEnd"] != null))
                {
                    ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "6") && m.cod_cliente == codCliente && m.data_tmst_end_datetime >= dateStart && m.data_tmst_end_datetime <= dateEnd).ToList();
                }
                else if (Session["selectedLojas"] == null && (Session["dateStart"] != null) && (Session["dateEnd"] == null))
                {
                    ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "6") && m.cod_cliente == codCliente && m.data_tmst_end_datetime >= dateStart).ToList();
                }
                else if (Session["selectedLojas"] == null && (Session["dateStart"] == null) && (Session["dateEnd"] != null))
                {
                    ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "6") && m.cod_cliente == codCliente && m.data_tmst_end_datetime <= dateEnd).ToList();
                }
            }
            else if (User.IsInRole("UserCofre"))
            {
                ...
                if (Session["selectedLojas"] != null && (Session["dateStart"] != null) && (Session["dateEnd"] != null))
                {
                    ...
                    ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "6") && cofreList.Contains(m.id_cofre) && selectedLojas.Contains(m.id_loja) && m.data_tmst_end_datetime >= dateStart && m.data_tmst_end_datetime <= dateEnd).ToList();
                }
                else if (Session["selectedLojas"] != null && (Session["dateStart"] != null) && (Session["dateEnd"] == null))
                {
                    var selectedLojas = (List<long>)Session["selectedLojas"];

                    ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "6") && cofreList.Contains(m.id_cofre) && selectedLojas.Contains(m.id_loja) && m.data_tmst_end_datetime >= dateStart).ToList();
                }
                else if (Session["selectedLojas"] != null && (Session["dateStart"] == null) && (Session["dateEnd"] != null))
                {
                    var selectedLojas = (List<long>)Session["selectedLojas"];

                    ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "6") && cofreList.Contains(m.id_cofre) && selectedLojas.Contains(m.id_loja) && m.data_tmst_end_datetime <= dateEnd).ToList();
                }
                else if (Session["selectedLojas"] == null && (Session["dateStart"] != null) && (Session["dateEnd"] != null))
                {
                    ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "6") && cofreList.Contains(m.id_cofre) && m.data_tmst_end_datetime >= dateStart && m.data_tmst_end_datetime <= dateEnd).ToList();
                }
                else if (Session["selectedLojas"] == null && (Session["dateStart"] != null) && (Session["dateEnd"] == null))
                {
                    ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "6") && cofreList.Contains(m.id_cofre) && m.data_tmst_end_datetime >= dateStart).ToList();
                }
                else if (Session["selectedLojas"] == null && (Session["dateStart"] == null) && (Session["dateEnd"] != null))
                {
                    ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "6") && cofreList.Contains(m.id_cofre) && m.data_tmst_end_datetime <= dateEnd).ToList();
                }
            }
            else
            {
