<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="cnGridOperacoes.aspx.cs" Inherits="rxApp.frmAgyliti.GetLock.cnMovimentos.cnGridOperacoes" %>
    ...
    <strong>Depósitos</strong>
        <dx:ASPxGridView runat="server" Width="100%" AutoGenerateColumns="False" KeyFieldName="id" ID="ASPxGridView1" OnDataBinding="ASPxGridView1_DataBinding" OnCustomUnboundColumnData="ASPxGridView1_CustomUnboundColumnData">
            ...
            <Columns>
                ...
                <dx:GridViewDataDateColumn FieldName="data_tmst_end_datetime" SortIndex="1" SortOrder="Ascending" ShowInCustomizationForm="True" Caption="Hora Movimento" VisibleIndex="1">
                ...
                <dx:GridViewDataTextColumn FieldName="data_hash" ShowInCustomizationForm="True" Caption="Hash" VisibleIndex="3"></dx:GridViewDataTextColumn>
