    ...
    public partial class cnGridColetas : System.Web.UI.Page
    {
        ...
        protected void ASPxGridView1_DataBinding(object sender, EventArgs e)
        {
            ...
            if (User.IsInRole("User"))
            {
                ...
                ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "5") && m.cod_loja == codLoja && m.data_tmst_end_datetime >= dateStart && m.data_tmst_end_datetime <= dateEnd).ToList();
            }
            else if (User.IsInRole("UserClient"))
            {
                ...
                if (Session["selectedLojas"] != null && (Session["dateStart"] != null) && (Session["dateEnd"] != null))
                {
                    ...
                    ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "5") && m.cod_cliente == codCliente && selectedLojas.Contains(m.id_loja) && m.data_tmst_end_datetime >= dateStart && m.data_tmst_end_datetime <= dateEnd).ToList();
                }
                else if (Session["selectedLojas"] != null && (Session["dateStart"] != null) && (Session["dateEnd"] == null))
                {
                    var selectedLojas = (List<long>)Session["selectedLojas"];

                    ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "5") && m.cod_cliente == codCliente && selectedLojas.Contains(m.id_loja) && m.data_tmst_end_datetime >= dateStart).ToList();
                }
                else if (Session["selectedLojas"] != null && (Session["dateStart"] == null) && (Session["dateEnd"] != null))
                {
                    var selectedLojas = (List<long>)Session["selectedLojas"];

                    ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "5") && m.cod_cliente == codCliente && selectedLojas.Contains(m.id_loja) && m.data_tmst_end_datetime <= dateEnd).ToList();
                }
                else if (Session["selectedLojas"] == null && (Session["dateStart"] != null) && (Session["dateEnd"] != null))
                {
                    ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "5") && m.cod_cliente == codCliente && m.data_tmst_end_datetime >= dateStart && m.data_tmst_end_datetime <= dateEnd).ToList();
                }
                else if (Session["selectedLojas"] == null && (Session["dateStart"] != null) && (Session["dateEnd"] == null))
                {
                    ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "5") && m.cod_cliente == codCliente && m.data_tmst_end_datetime >= dateStart).ToList();
                }
                else if (Session["selectedLojas"] == null && (Session["dateStart"] == null) && (Session["dateEnd"] != null))
                {
            ...
            else
            {
                if (Session["selectedLojas"] != null && (Session["dateStart"] != null) && (Session["dateEnd"] != null))
                {
                    ...
                    ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "5") && selectedLojas.Contains(m.id_loja) && m.data_tmst_end_datetime >= dateStart && m.data_tmst_end_datetime <= dateEnd).ToList();
                }
                else if (Session["selectedLojas"] != null && (Session["dateStart"] != null) && (Session["dateEnd"] == null))
                {
                    var selectedLojas = (List<long>)Session["selectedLojas"];

                    ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "5") && selectedLojas.Contains(m.id_loja) && m.data_tmst_end_datetime >= dateStart).ToList();
                }
                else if (Session["selectedLojas"] != null && (Session["dateStart"] == null) && (Session["dateEnd"] != null))
                {
                    var selectedLojas = (List<long>)Session["selectedLojas"];

                    ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "5") && selectedLojas.Contains(m.id_loja) && m.data_tmst_end_datetime <= dateEnd).ToList();
                }
                else if (Session["selectedLojas"] == null && (Session["dateStart"] != null) && (Session["dateEnd"] != null))
                {
                    ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "5") && m.data_tmst_end_datetime >= dateStart && m.data_tmst_end_datetime <= dateEnd).ToList();
                }
                else if (Session["selectedLojas"] == null && (Session["dateStart"] != null) && (Session["dateEnd"] == null))
                {
                    ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "5") && m.data_tmst_end_datetime >= dateStart).ToList();
                }
                else if (Session["selectedLojas"] == null && (Session["dateStart"] == null) && (Session["dateEnd"] != null))
                {
                    ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "5") && m.data_tmst_end_datetime <= dateEnd).ToList();
                }
            }
