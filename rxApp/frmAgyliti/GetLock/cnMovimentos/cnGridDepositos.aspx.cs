    ...
    public partial class cnGridDepositos : System.Web.UI.Page
    {
        ...
        protected void ASPxGridView1_DataBinding(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //ds = db.GetLockMessageViews.AsNoTracking().Where(m => (m.data_type == "1" || m.data_type == "2" || m.data_type == "3" || m.data_type == "4") && m.data_tmst_end_datetime >= dateIni && m.data_tmst_end_datetime <= dateEnd).ToList();
            }
